...
public class TableSorter extends AbstractTableModel {
	...
	public int modelIndex(int viewIndex) {
		synchronized (viewToModelLock) {
			try {
				...
				return -1; // fix: Not sure why in some cases this exception is thrown.
			}
		}
	}
	...
	public Object getValueAt(int row, int column) {
		try {
			...
			// Has been detected under some stress tests on large tables (1000 rows)
			// Probably due to concurrent modification from 2 threads
			// Unfortunatelly syhchronizing methods deadlocks the system rather than
			// solving the exception.
			// This workaround will just trap the exception and ignore the sorting for
			// this element.
