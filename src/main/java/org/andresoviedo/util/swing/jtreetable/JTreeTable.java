...
public class JTreeTable extends JTable {
	...
	public JTreeTable(TreeTableModel treeTableModel) {
		...
		super.setModel(adapter = new TreeTableModelAdapter(treeTableModel, tree));
	...
	/**
	 * Overridden to message super and forward the method to the tree. Since the tree is not actually in the component hieachy it will never
	 * receive this unless we forward it in this manner.
	 */
	...
	/**
	 * Overridden to pass the new height to the tree.
	 * 
	...
	public static class ExpandAllAction extends AbstractAction {
		...
		public ExpandAllAction(JTreeTable treeTable) {
			super(Resources.getString(Resources.ACTION_NAME_EXPAND_ALL));
			putValue(Action.ACTION_COMMAND_KEY, "expand-all");
			putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_E, KeyEvent.CTRL_DOWN_MASK | KeyEvent.SHIFT_DOWN_MASK));
			putValue(Action.SHORT_DESCRIPTION, Resources.getString(Resources.ACTION_DESCRIPTION_EXPAND_ALL));
	...
	/**
	 * An action to bind to a <code>JTreeTable</code> to collapse all nodes.
	 */
	public static class CollapseAllAction extends AbstractAction {

		private JTreeTable treeTable;

		public CollapseAllAction(JTreeTable treeTable) {
			super(Resources.getString(Resources.ACTION_NAME_COLLAPSE_ALL));
			putValue(Action.ACTION_COMMAND_KEY, "collapse-all");
			putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_DOWN_MASK | KeyEvent.SHIFT_DOWN_MASK));
			putValue(Action.SHORT_DESCRIPTION, Resources.getString(Resources.ACTION_DESCRIPTION_COLLAPSE_ALL));
			this.treeTable = treeTable;
		}
